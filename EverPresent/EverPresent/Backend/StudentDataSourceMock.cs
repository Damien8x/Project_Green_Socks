...
public class StudentDataSourceMock
    {
           ...
           private StudentDataSourceMock() { }
            ...
            public void Initialize()
            {
             ...
             StudentStatusEnum studentStatusEnum3 = StudentStatusEnum.Out;
                 ...
                 var count = 0;
               studentList.Add(new StudentModel("avatar" + count++.ToString(), "John", studentStatusEnum1));
               studentList.Add(new StudentModel("avatar" + count++.ToString(), "Andrew", studentStatusEnum2));
               studentList.Add(new StudentModel("avatar" + count++.ToString(), "Jeff", studentStatusEnum1));
               studentList.Add(new StudentModel("avatar" + count++.ToString(), "Megan", studentStatusEnum3));
               studentList.Add(new StudentModel("avatar" + count++.ToString(), "Britney", studentStatusEnum2));
